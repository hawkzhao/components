...
public class MarkLogicConnectionProperties extends ComponentPropertiesImpl implements MarkLogicProvideConnectionProperties, DatastoreProperties {
    ...
    public ValidationResult validateTestConnection() throws Exception {
        ...
        try (SandboxedInstance sandbox = SandboxInstanceFactory.createSandboxedInstance(
                MarkLogicDatastoreDefinition.getRuntimeInfo(), MarkLogicConnectionProperties.class.getClassLoader(), false)) {

            DatastoreRuntime<MarkLogicConnectionProperties> datastoreRuntime =
                    (DatastoreRuntime<MarkLogicConnectionProperties>) sandbox.getInstance();
