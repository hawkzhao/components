...
public class AggregateRuntimeTest {
    ...
    private final List<IndexedRecord> basicList = Arrays.asList(basic1, basic2, basic3, basic4, basic5, basic6);
    ...
    private final List<IndexedRecord> minIntResList = Arrays.asList(basicResult1, basicResult2, basicResult3);
